          ...
          <div className="relative">
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl ring-4 ring-primary/20 hover:ring-primary/40 transition-all duration-300 hover:scale-[1.02] transform will-change-transform bg-black">
              ...
              <picture>
                <source
                  type="image/webp"
                  srcSet="/images/before-empty-room.jpg?format=webp&width=640 640w,
                          /images/before-empty-room.jpg?format=webp&width=1024 1024w,
                          /images/before-empty-room.jpg?format=webp&width=1920 1920w"
              ...
              clipPath: `inset(0 0 0 ${sliderPosition}%)`
                ...
                <picture>
                  <source
                    type="image/webp"
                    srcSet="/images/after-staged-room.jpg?format=webp&width=640 640w,
                            /images/after-staged-room.jpg?format=webp&width=1024 1024w,
                            /images/after-staged-room.jpg?format=webp&width=1920 1920w"
                    sizes="(max-width: 640px) 100vw, (max-width: 1024px) 90vw, 50vw"
                  />
                  <img 
