          ...
          <div className="relative">
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl ring-4 ring-primary/20 hover:ring-primary/40 transition-all duration-300 hover:scale-[1.02] transform will-change-transform bg-black">
              ...
              <img 
                ...
                className="absolute top-0 left-0 w-full h-full object-cover object-center scale-[1.16] sm:scale-[1.12] lg:scale-[1.08] -translate-y-2 sm:-translate-y-2 will-change-transform"
                width="1120" 
                height="838" 
                loading="eager" 
                decoding="async" 
              ...
              clipPath: `inset(0 0 0 ${sliderPosition}%)`
                ...
                <img 
                  ...
                  className="absolute top-0 left-0 w-full h-full object-cover object-center scale-[1.08] will-change-transform"
                  width="1120" 
                  height="838" 
                  loading="eager" 
                  decoding="async" 
