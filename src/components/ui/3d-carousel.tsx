              ...
              >
                <div className="relative">
                  <motion.img
                    ...
                    className="pointer-events-none w-full rounded-xl object-cover aspect-square border-4 border-border shadow-lg scale-110"
...
function ThreeDPhotoCarousel({ items }: { items: { image: string; title: string }[] }) {
