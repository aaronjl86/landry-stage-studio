        ...
        >
          {cards.map((item, i) => (
            <motion.div
              ...
              className="absolute flex h-full origin-center items-center justify-center rounded-xl bg-transparent p-0"
              style={{
                width: `${faceWidth}px`,
                transform: `rotateY(${
                  i * (360 / faceCount)
            ...
            >
              <img
                src={item.image}
                alt={item.title}
                className="pointer-events-none w-full rounded-md object-cover aspect-square ring-0 scale-100"
              />
            </motion.div>
          ))}
        </motion.div>
