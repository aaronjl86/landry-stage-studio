...
export default function ThreeDCarousel({
  ...
  return <div className="relative isolate w-full max-w-6xl mx-auto mb-16">
      ...
      <div className="relative h-[300px] overflow-visible">
        <div className="relative w-full h-full flex items-center pt-0 -ml-16" style={{
        perspective: "1200px"
      }}>
      ...
      <div className="flex justify-center gap-4 mt-4 px-0 py-[15px]">
        <Button variant="outline" size="icon" onClick={handlePrev} disabled={isAnimating} className="rounded-full">
          <ChevronLeft className="h-5 w-5" />
        </Button>
        <Button variant="outline" size="icon" onClick={handleNext} disabled={isAnimating} className="rounded-full">
