        ...
        >
          {items.map((item, index) => {
            ...
            return (
              ...
              >
                <div className="relative w-full h-full rounded-xl overflow-hidden shadow-2xl bg-background">
                  <img
                    src={item.image}
                    alt={item.title}
                    className="absolute inset-x-0 -top-16 w-full h-[calc(100%+64px)] object-cover"
                  />
