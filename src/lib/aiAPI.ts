...
export const TEMPLATE_PROMPTS = {
  ...
  decluttering:
    "Remove ALL furniture, decor, personal items, and movable objects to create a completely empty room. ABSOLUTELY FORBIDDEN: changing walls, floors, ceiling, windows, doors, moldings, built-ins, fixtures, or any permanent architectural features. Windows must remain structurally unchanged (no altering window frames, glass, or positions). The room structure, dimensions, windows, doors, and all architectural elements must remain EXACTLY as they are. Result must be a clean empty space with perfect architectural preservation.",
  "virtual-staging":
    "Add ONLY furniture and decor to this room. ABSOLUTELY FORBIDDEN: adding, removing, or moving walls, floors, ceiling, windows, doors, or any structural elements. Windows must remain structurally unchanged (window treatments like curtains/drapes are allowed). NEVER place furniture blocking the window openings. The architecture must remain 100% unchanged. Add only movable furniture (sofas, tables, chairs, beds, lamps) and decorative items (art, plants, accessories) positioned appropriately in the space.",
  "sky-replacement":
